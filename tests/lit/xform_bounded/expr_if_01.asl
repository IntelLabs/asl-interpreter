...
// XFORM-NEXT:  begin
// XFORM-NEXT:      let r : __sint(9) = asl_cvt_int_sintN.0{9}(if asl_ge_int.0{}(x, asl_cvt_sintN_int.0{10}(i10'x256)) then asl_cvt_sintN_int.0{9}(i9'x255) elsif asl_lt_int.0{}(x, asl_cvt_sintN_int.0{1}(i1'x0)) then asl_cvt_sintN_int.0{1}(i1'x0) else x, 9);
